...
import os
import sys
from models.cla_models import swin_small_patch4_window7_224, resnet101, resnet50, resnet18, resnet34
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('../runner/Running_Dict/EGG_node 第5折 0.8799 0.8466.pth'))
    model.eval()
    model.cuda()
